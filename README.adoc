...
:hide-uri-scheme:
// Project URLs:
:url-project: https://gitlab.com/gianet/moegui/mktg/docs-ui.moegui.com
:url-preview: https://gianet.gitlab.io/moegui/mktg/docs-ui.moegui.com
...
While the UI is ready to be used with Antora, the intent is that you'll fork it and customize it for your own needs.
...
ui:
  bundle:
    url: https://gitlab.com/gianet/moegui/mktg/docs-ui.moegui.com/-/jobs/artifacts/master/raw/build/ui-bundle.zip?job=bundle-stable
    snapshot: true
----
...
Read on to learn how to customize the UI for your own documentation.
...
To make Node.js 10 the in new terminals, type:
...
The example above clones Antora's UI project and then switches to the project folder on your filesystem.
