...
:hide-uri-scheme:
// Project URLs:
:url-project: https://gitlab.com/moegui/docs-ui.moegui.com
:url-preview: https://moegui.gitlab.io/docs-ui.moegui.com
...
ui:
  bundle:
    url: https://gitlab.com/moegui/docs-ui.moegui.com/-/jobs/artifacts/master/raw/build/ui-bundle.zip?job=bundle-stable
    snapshot: true
----
